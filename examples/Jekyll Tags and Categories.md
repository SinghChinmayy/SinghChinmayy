...
Here’s a more complex example, which prints the list of tags as a sentence with punctuation (example: Movies, Things I Like, and Reviews).
...
collections: tags: output: true permalink: tag/:title/
...
name: Movies cover: assets/images/movies.jpg — These are my movie reviews!
...
layout: post title: Mad Max: Fury Road date: 2015-05-15 16:00:00 +0100 tags: movies —
...
{% raw %}{% for tag in site.tags %} {% if post.tags contains tag.name or tag.name == post.tags %} {{ tag.name }} {% endif %} {% endfor %}{% endraw %}
...
{% raw %}{% assign tagdata = ‘’ | split:’@’ %} {% for tag in site.tags %} {% if post.tags contains tag.name or tag.name == post.tags %} {% capture data %} {{ tag.name }} {% endcapture %} {% assign tagdata = tagdata | push: data %} {% endif %} {% endfor %}

{{ tagdata | array_to_sentence_string }}
...
{% raw %}{% assign number_of_posts = 0 %} {% for post in site.posts %} {% if post.tags contains page.name or page.name == post.tags %} {% assign number_of_posts = number_of_posts | plus: 1 %} {% endif %} {% endfor %} {% if number_of_posts == 0 %}No posts{% elsif number_of_posts == 1 %}1 post{% else %}{{ number_of_posts }} posts{% endif %}{% endraw %}
...
{% raw %}{% raw %}{% for post in site.posts %} {% if post.tags contains page.name or page.name == post.tags %} {{ post.title }} {% endif %} {% endfor %}{% endraw %}
